...
class DataPoint:
    ...
    each DataPoint may have Labels in several layers of annotations (hence the functions add_label(), get_labels()
...
class Span(DataPoint):
    ...
    def to_dict(self):
        return {
            "Textual target labels": self.to_original_text(),
...
class Sentence(DataPoint):
    """
       A Sentence is a list of Tokens and is used to represent a sentence or Textual target labels fragment.
    """
    ...
    def __init__(
        ...
        """
        Class to hold all meta related to a Textual target labels (tokens, predictions, language code, ...)
        ...
        # if Textual target labels is passed, instantiate sentence with tokens (words)
        if text is not None:
    ...
    def infer_space_after(self):
        """
        Heuristics in case you wish to infer whitespace_after values for tokenized Textual target labels. This is useful for some old NLP
    ...
    def to_dict(self, tag_type: str = None):
        ...
        return {"Textual target labels": self.to_original_text(), "labels": labels, "entities": entities}
