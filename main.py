...
def parse_arguments():
    ...
    parser.add_argument("--image_obj_boxes_dir", dest="image_obj_boxes_dir", type=str,
                        default="datasets/Visual target labels")
    ...
    parser.add_argument("--num_epochs", dest="num_epochs", type=int, default=60)
    ...
    parser.add_argument("--model_file_name", dest="model_file_name", type=str, default="path_to_weights")
